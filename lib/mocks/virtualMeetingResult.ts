...
export const VIRTUAL_TRANSCRIPT_SEGMENTS: TranscriptSegment[] = [
  {
    id: "virtual-seg-1",
    text: "오늘은 2024년 마케팅 전략회의를 시작하겠습니다. 회의 목적은 3분기 마케팅 전략 수립입니다. 참석자는 김팀장, 이대리, 박사원, 최사원입니다.",
    startedAtSec: 0,
    endedAtSec: 40,
    speakerLabel: "화자 A",
  ...
  {
    id: "virtual-seg-2",
    text: "안건 1, 2분기 마케팅 성과 리뷰입니다. 온라인 광고 캠페인 성과 분석 결과를 발표하겠습니다. 전반적으로 전환율이 개선되었고, 예산 대비 효율도 양호했습니다.",
    startedAtSec: 48,
    endedAtSec: 100,
    speakerLabel: "화자 B",
    originalSpeakerLabel: "B",
  },
  {
    id: "virtual-seg-3",
    text: "소셜 미디어 인게이지먼트 통계를 공유합니다. 반응은 늘어났지만 전환으로 이어지는 전략은 재검토가 필요합니다.",
    startedAtSec: 112,
    endedAtSec: 160,
    speakerLabel: "화자 C",
    originalSpeakerLabel: "C",
  },
  {
    id: "virtual-seg-4",
    text: "온라인 광고 예산 10% 증액을 결정하겠습니다. 박사원은 소셜 미디어 전략을 2024년 6월 30일까지 재검토해 주세요.",
    startedAtSec: 168,
    endedAtSec: 210,
    speakerLabel: "화자 A",
    originalSpeakerLabel: "A",
  ...
  {
    id: "virtual-seg-5",
    text: "안건 2, 3분기 마케팅 전략입니다. 새로운 타겟 시장 조사 결과를 발표합니다. 신규 세그먼트에서 수요가 확인되었습니다.",
    startedAtSec: 220,
    endedAtSec: 270,
    speakerLabel: "화자 D",
    originalSpeakerLabel: "D",
  },
  {
    id: "virtual-seg-6",
    text: "경쟁사 분석 보고입니다. 신규 타겟 시장을 겨냥한 캠페인 실행을 결정합니다. 이대리는 2024년 7월 10일까지 신규 캠페인 기획안을 작성해 주세요.",
    startedAtSec: 278,
    endedAtSec: 330,
    speakerLabel: "화자 A",
    originalSpeakerLabel: "A",
  ...
  {
    id: "virtual-seg-7",
    text: "다음 회의는 2024년 7월 15일 오전 10시입니다. 추가 논의 사항으로 마케팅 예산 재분배를 남겨 두겠습니다. 이상 회의를 마치겠습니다.",
    startedAtSec: 340,
    endedAtSec: 390,
    speakerLabel: "화자 A",
    originalSpeakerLabel: "A",
